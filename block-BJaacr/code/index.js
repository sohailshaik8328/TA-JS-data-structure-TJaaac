...
// for(let name_desc of got.houses[1].people){
//     console.log(`I am ${name_desc.name} and my bio is ${name_desc.description}`)
// }
...
for(let name_desc of got.houses[1].people){
  if(name_desc.name  === "Tywin Lannister"){
    console.log(`I am ${name_desc.name} and my bio is ${name_desc.description}`)
...
let obj = {}
for(let name_size of got.houses){
  obj[name_size.name] = name_size.people.length
}
console.log(obj)
// 15. Log the name of all the people of all the houses in got one by one
for(let name of got.houses){
  for(let people of name.people){
